...
const { register, login, refresh, logout, getMe, updateProfile, changePassword, forgotPassword, resetPassword, setup2FA, enable2FA, disable2FA, verify2FA } = require('../controllers/authController');
